        ...
        <div class = "col-12 col-sm-8 m-auto">
            <div class = "card">
                <div class = "text-center">
                    <img src="https://i.imgur.com/y1cHsOB.png" alt="user icon" height="auto" width="200px">
                </div>

                <div = "card-body">
                    <form action="admin.php" method="GET">
                        <h2>Email</h2>
                        <input type="text" name="user" id="user" class="form-control my-3 py-2" placeholder="E-mail">

                        <h2>Password</h2>
                        <input type="text" name="pass" id="pass" class="form-control my-3 py-2" placeholder="Password">
                            <div class = "text-center mt-3">
                                <button class="btn btn-primary">Login</button>
                                <a href="recover.php" class="nav-link">Forgot password?</a>
                            </div>
                    </form>
                </div>
            </div>
